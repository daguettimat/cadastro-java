...
import org.apache.deltaspike.proxy.api.DeltaSpikeProxyFactory.GeneratorHolder;
...
public class MotoristaFourInf {
	...
	public MotoristaFourInf() {
		service = JSON.std;
	}
	
	public MotoristaFourInf(JSON service){
	...
	public JSONObject getMotorista(String cpf , String nome, String rg ,
				String ufRg, String nomeMae, String dataNascimento, String Uf){
