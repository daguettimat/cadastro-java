...
public class TipoPerdaService extends CrudService<TipoPerda> {

	private static final long serialVersionUID = 201904181146L;
	
	@Override
    public Criteria configPagination(Filter<TipoPerda> filter) {
