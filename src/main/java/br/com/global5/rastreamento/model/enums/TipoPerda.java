...
@Entity
@Table(name = "rastreamento.enum_classificacao_perda")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class TipoPerda implements BaseEntity {
    ...
    public TipoPerda(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public TipoPerda(Integer id) {
        this.id = id;
    }

    public TipoPerda descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
