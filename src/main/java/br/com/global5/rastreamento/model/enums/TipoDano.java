...
@Entity
@Table(name = "rastreamento.enum_tipo_dano")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class TipoDano implements BaseEntity {
    ...
    public TipoDano(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public TipoDano(Integer id) {
        this.id = id;
    }

    public TipoDano descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
