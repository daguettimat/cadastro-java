...
public class TipoAnexo implements BaseEntity {
    ...
    public TipoAnexo(Integer id, String descricao){
    	this.id = id;
    	this.descricao = descricao;
    }

    public TipoAnexo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public TipoAnexo(Integer id) {
        this.id = id;
    }

    public TipoAnexo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
