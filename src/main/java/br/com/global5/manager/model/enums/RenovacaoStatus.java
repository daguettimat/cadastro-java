...
@Entity
@Table(name = "enum_renovacao_status")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class RenovacaoStatus implements BaseEntity {
    ...
    public RenovacaoStatus() {
    }

    public RenovacaoStatus(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public RenovacaoStatus(Integer id) {
        this.id = id;
    }

    public RenovacaoStatus descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
