...
@Entity
@Table(name = "enum_horario_funcionamento")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class HorarioFuncionamento implements BaseEntity {
    ...
    public HorarioFuncionamento(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public HorarioFuncionamento(Integer id) {
        this.id = id;
    }

    public HorarioFuncionamento descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
