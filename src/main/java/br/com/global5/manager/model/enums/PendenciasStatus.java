...
@Entity
@Table(name = "enum_pendencia_status")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class PendenciasStatus implements BaseEntity {
    ...
    public PendenciasStatus() {
    }

    public PendenciasStatus(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public PendenciasStatus(Integer id) {
        this.id = id;
    }

    public PendenciasStatus descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
