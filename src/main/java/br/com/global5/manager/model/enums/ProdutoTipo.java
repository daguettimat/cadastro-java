...
@Entity
@Table(name = "enum_produto_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ProdutoTipo implements BaseEntity {
    ...
    public ProdutoTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
    ...
    public ProdutoTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
