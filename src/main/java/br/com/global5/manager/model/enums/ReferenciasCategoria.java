...
@Entity
@Table(name = "enum_referencias_categoria")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ReferenciasCategoria implements BaseEntity {
    ...
    public ReferenciasCategoria() {
    }

    public ReferenciasCategoria(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ReferenciasCategoria(Integer id) {
        this.id = id;
    }

    public ReferenciasCategoria descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
