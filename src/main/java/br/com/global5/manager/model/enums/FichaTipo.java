...
@Entity
@Table(name = "enum_ficha_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class FichaTipo implements BaseEntity {
    ...
    public FichaTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public FichaTipo(Integer id) {
        this.id = id;
    }

    public FichaTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
