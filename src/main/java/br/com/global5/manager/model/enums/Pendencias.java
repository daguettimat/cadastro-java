...
@Entity
@Table(name = "enum_pendencia_categoria")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class Pendencias implements BaseEntity {
    ...
    public Pendencias(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public Pendencias(Integer id) {
        this.id = id;
    }

    public Pendencias descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
