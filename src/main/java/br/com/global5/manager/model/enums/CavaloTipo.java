...
@Entity
@Table(name = "enum_cavalo_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class CavaloTipo implements BaseEntity {
    ...
    public CavaloTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public CavaloTipo(Integer id) {
        this.id = id;
    }

    public CavaloTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
