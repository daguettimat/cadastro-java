...
@Entity
@Table(name = "enum_ferramentas_seguranca")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class FerramentasSeguranca implements BaseEntity {
    ...
    public FerramentasSeguranca() {
    }

    public FerramentasSeguranca(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public FerramentasSeguranca(Integer id) {
        this.id = id;
    }

    public FerramentasSeguranca descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
