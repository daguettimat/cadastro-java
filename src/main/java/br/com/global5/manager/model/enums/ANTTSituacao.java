...
@Entity
@Table(name = "enum_antt_situacao")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ANTTSituacao implements BaseEntity {
    ...
    public ANTTSituacao(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ANTTSituacao(Integer id) {
        this.id = id;
    }

    public ANTTSituacao descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
