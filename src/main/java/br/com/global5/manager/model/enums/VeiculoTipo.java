...
@Entity
@Table(name = "enum_veiculo_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class VeiculoTipo implements BaseEntity {
    ...
    public VeiculoTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public VeiculoTipo(Integer id) {
        this.id = id;
    }

    public VeiculoTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
