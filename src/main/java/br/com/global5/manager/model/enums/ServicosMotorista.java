...
@Entity
@Table(name = "enum_servicos_motoristas")
@XmlRootElement
...
public class ServicosMotorista implements BaseEntity {
    ...
    public ServicosMotorista(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
    ...
    public ServicosMotorista descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
