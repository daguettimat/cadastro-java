...
@Entity
@Table(name = "enum_fatura_agrupamento")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class FaturaAgrupamento implements BaseEntity {
    ...
    public FaturaAgrupamento() {
    }

    public FaturaAgrupamento(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public FaturaAgrupamento(Integer id) {
        this.id = id;
    }

    public FaturaAgrupamento descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
