...
@Entity
@Table(name = "enum_referencias_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ReferenciasTipo implements BaseEntity {
    ...
    public ReferenciasTipo() {
    }

    public ReferenciasTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ReferenciasTipo(Integer id) {
        this.id = id;
    }

    public ReferenciasTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
