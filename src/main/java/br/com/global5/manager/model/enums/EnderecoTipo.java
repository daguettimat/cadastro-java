...
public class EnderecoTipo implements BaseEntity {
    ...
    public EnderecoTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
    ...
    public EnderecoTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
