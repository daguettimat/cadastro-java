...
@Entity
@Table(name = "enum_referencias_avaliacao")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ReferenciasAvaliacao implements BaseEntity {
    ...
    public ReferenciasAvaliacao() {
    }

    public void ReferenciasAvaliacao(Integer id) {
        this.id = id;
    }

    public ReferenciasAvaliacao(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ReferenciasAvaliacao(Integer id) {
        this.id = id;
    }

    public ReferenciasAvaliacao descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
