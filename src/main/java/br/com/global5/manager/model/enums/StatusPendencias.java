...
public class StatusPendencias implements BaseEntity {
    ...
    public StatusPendencias() {
    }

    public StatusPendencias(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public StatusPendencias(Integer id) {
        this.id = id;
    }

    public StatusPendencias descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
