...
@Entity
@Table(name = "enum_avaliacao_ponto")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class AvaliacaoPonto implements BaseEntity {
    ...
    public AvaliacaoPonto(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public AvaliacaoPonto(Integer id) {
        this.id = id;
    }

    public AvaliacaoPonto descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
