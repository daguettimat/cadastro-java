...
@Entity
@Table(name = "enum_telefone_origem")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class TelefoneOrigem implements BaseEntity {
    ...
    public TelefoneOrigem() {
    }

    public TelefoneOrigem(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public TelefoneOrigem(Integer id) {
        this.id = id;
    }

    public TelefoneOrigem descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
