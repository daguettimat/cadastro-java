...
@Entity
@Table(name = "enum_manutencao_abastecimento")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ManutencaoAbastecimento implements BaseEntity {
    ...
    public ManutencaoAbastecimento() {
    }

    public ManutencaoAbastecimento(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ManutencaoAbastecimento(Integer id) {
        this.id = id;
    }

    public ManutencaoAbastecimento descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
