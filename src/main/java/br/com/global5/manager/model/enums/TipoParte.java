...
@Entity
@Table(name = "enum_tipo_parte")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class TipoParte implements BaseEntity {
    ...
    public TipoParte(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public TipoParte(Integer id) {
        this.id = id;
    }

    public TipoParte descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
