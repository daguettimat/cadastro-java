...
@Entity
@Table(name = "enum_telefone_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class TelefoneTipo implements BaseEntity {
    ...
    public TelefoneTipo(Integer id) {
        this.id = id;
    }

    public TelefoneTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
