...
@Entity
@Table(name = "enum_perfil_faturamento")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class PerfilFaturamento implements BaseEntity {
    ...
    public PerfilFaturamento() {
    }

    public PerfilFaturamento(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public PerfilFaturamento(Integer id) {
        this.id = id;
    }

    public PerfilFaturamento descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
