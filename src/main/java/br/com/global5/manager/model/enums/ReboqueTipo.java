...
@Entity
@Table(name = "enum_reboque_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ReboqueTipo implements BaseEntity {
    ...
    public ReboqueTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ReboqueTipo(Integer id) {
        this.id = id;
    }

    public ReboqueTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
