...
@Entity
@Table(name = "enum_tipo_apoio")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class TipoApoio implements BaseEntity {
    ...
    public TipoApoio(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public TipoApoio(Integer id) {
        this.id = id;
    }

    public TipoApoio descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
