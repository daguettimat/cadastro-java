...
@Entity
@Table(name = "enum_cnh_categoria")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class CNHCategoria implements BaseEntity {
    ...
    public CNHCategoria(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public CNHCategoria(Integer id) {
        this.id = id;
    }

    public CNHCategoria descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
