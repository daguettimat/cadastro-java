...
@Entity
@Table(name = "enum_ficha_status")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class FichaStatus implements BaseEntity {
    ...
    public FichaStatus(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public FichaStatus(Integer id) {
        this.id = id;
    }

    public FichaStatus descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
