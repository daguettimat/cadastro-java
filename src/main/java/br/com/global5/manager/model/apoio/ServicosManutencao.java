...
@Entity
@Table(name = "pontos_apoio_servico_manut_abast")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ServicosManutencao implements BaseEntity {
    ...
    @ManyToOne(
            fetch=FetchType.LAZY,
            targetEntity=ManutencaoAbastecimento.class,
            cascade={CascadeType.DETACH, CascadeType.MERGE}
    )
    @JoinColumn(name="ptosrv_enumoid")
    private ManutencaoAbastecimento tipo;
    ...
    public ServicosManutencao(Integer id) {
        this.id = id;
    }


    public ServicosManutencao(int id, PontosApoio pontosApoio, int tipo, boolean disponivel,
                              HorarioFuncionamento horarioFuncionamento, double valor, String observacoes) {
        this.id = id;
        this.pontosApoio = pontosApoio;
        this.tipo = new ManutencaoAbastecimento(tipo);
    ...
    public ServicosManutencao(PontosApoio pontosApoio, int tipo, boolean disponivel,
                              HorarioFuncionamento horarioFuncionamento, double valor, String observacoes) {
        this.pontosApoio = pontosApoio;
        this.tipo = new ManutencaoAbastecimento(tipo);
        this.disponivel = disponivel;
    ...
    public ManutencaoAbastecimento getTipo() {
        return tipo;
    }

    public void setTipo(ManutencaoAbastecimento tipo) {
        this.tipo = tipo;
    }
