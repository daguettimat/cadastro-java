 ...
 *
 */
@Path("/analise/consulta/pessoa")
@Produces("application/json;charset=utf-8")
public class ConsultaPessoaEndPoint {
    ...
    public Response create(acConsultaPessoa entity) {
        ...
        return Response.created(UriBuilder.fromResource(ConsultaPessoaEndPoint.class).path(String.valueOf(entity.getId())).build()).build();
    }
