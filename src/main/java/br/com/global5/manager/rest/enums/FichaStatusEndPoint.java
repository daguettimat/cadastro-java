...
*
*/
@Path("/enums/ficha/status")
@Produces("application/json;charset=utf-8")
public class FichaStatusEndPoint {

	@Inject
    FichaStatusService ficService;
    ...
    public Response create(FichaStatus entity) {
    	...
    	return Response.created(UriBuilder.fromResource(FichaStatusEndPoint.class).path(String.valueOf(entity.getId())).build()).build();
    }
    ...
    public Response deleteById(@HeaderParam("user") String user, @PathParam("id") Integer id) { 
    	FichaStatus entity = ficService.findById(id);
    	if( entity == null ) {
    ...
    public Response list(@QueryParam("start") @DefaultValue("0") Integer startPosition,
       ...
       final List<FichaStatus> results = ficService.paginate(filter);
