...
public class ServicosMotoristaEndPoint {
    ...
    public Response create(ServicosMotorista entity) {
    	...
    	return Response.created(UriBuilder.fromResource(ServicosMotoristaEndPoint.class)
    ...
    public Response deleteById(@HeaderParam("user") String user, @PathParam("id") Integer id) {
    	ServicosMotorista entity = motService.findById(id);
    	if( entity == null ) {
    ...
    public Response list(@QueryParam("start") @DefaultValue("0") Integer startPosition,
       ...
       final List<ServicosMotorista> results = motService.paginate(filter);
