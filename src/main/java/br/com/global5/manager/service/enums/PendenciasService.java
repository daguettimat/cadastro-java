...
/**
 * PendenciasService ( Regras de Negócio )
 * @author zielinski
 * @date 2017-02-21 15:09
 */

public class PendenciasService extends CrudService<Pendencias> {
	...
	@Override
    public Criteria configPagination(Filter<Pendencias> filter) {
    ...
    @Override
    public void beforeInsert(Pendencias Pendencias) {
    ...
    @Override
    public void beforeUpdate(Pendencias entity) {
    ...
    @Override
    @Admin
    public void remove(Pendencias car) {
        super.remove(car);
    }
