...
/**
 * ReferenciasTipoContatoService ( Regras de Negócio )
 * @author zielinski
 * @date 2017-02-21 15:09
 */

public class ReferenciasTipoContatoService extends CrudService<ReferenciasTipoContato> {
	...
	@Override
    public Criteria configPagination(Filter<ReferenciasTipoContato> filter) {
    ...
    @Override
    public void beforeInsert(ReferenciasTipoContato ReferenciasTipoContato) {
        if (!ReferenciasTipoContato.hasDescricao()) {
    ...
    @Override
    public void beforeUpdate(ReferenciasTipoContato entity) {
    ...
    @Override
    @Admin
    public void remove(ReferenciasTipoContato car) {
        super.remove(car);
    }
