...
@Entity
@Table(name = "enum_chamado_tipo")
@XmlRootElement
@XmlAccessorType(value = XmlAccessType.FIELD)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ChamadoTipo implements BaseEntity {
    ...
    public ChamadoTipo(Integer id, String descricao, Timestamp exclusao) {
        this.id = id;
        this.descricao = descricao;
        this.exclusao = exclusao;
    }

    public ChamadoTipo(Integer id) {
        this.id = id;
    }

    public ChamadoTipo descricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
